 ...
 */
package com.kuafuai.manage.mcp.server.transport;

import com.fasterxml.jackson.core.type.TypeReference;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.kuafuai.common.util.StringUtils;
import com.kuafuai.manage.mcp.spec.*;
...
public class HttpServletSseServerTransportProvider extends HttpServlet implements McpServerTransportProvider {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (StringUtils.isEmpty(Strings.trimAllWhitespace(token))) {
        ...
        this.sendEvent(writer, ENDPOINT_EVENT_TYPE, messageEndpoint + "?sessionId=" + sessionId + "&token=" + token);
    }
