...
public class HuoshanMusicSign {
    ...
    public static HuoshanSignResult signResult(String accessKey, String secretKey, String method, Map<String, String> queryList, byte[] body,
                                               Date date, String action, String version, String host, String service) throws Exception {
        if (body == null) {
            body = new byte[0];
        }
