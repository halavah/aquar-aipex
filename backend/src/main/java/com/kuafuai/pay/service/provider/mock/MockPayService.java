package com.kuafuai.pay.service.provider.mock;
...
public class MockPayService implements PayService<PaymentOrderDetail> {
    ...
    public String getPayId(Map<String, Object> param) {
        return (String) param.getOrDefault("paymentOrderId","");
    }

    @Override
    public Object getPaymentParam(String paymentOrderId, Map<String,Object> extraParams) {
        ...
        mockParams.put("orderNo", extraParams.getOrDefault("orderNo","").toString());
